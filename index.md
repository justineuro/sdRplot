...
* [sdRplot.R](./sdRplot/index.md) - the [**R**](https://svn.R-project.org/R/) script (raw source at [sdRplot.R](raw source at [sdRplot.R](https://raw.githubusercontent.com/justineuro/sdRplot/master/sdRplot.R))
* [sdRplot.html](http://justineuro.github.io/sdRplot/sdRplot.html) - a [**knitr**](http://yihui.name/knitr/)-generated output of the example in the script (HTML source at [sdRplot.html](https://github.com/justineuro/sdRplot/sdRplot.html))
